...
public class StudentStartTest extends AppCompatActivity {
    String mobile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = new ProgressDialog(StudentStartTest.this);
            ...
            if(quesId > 19){
                    ...
                    public void onClick(View view) {
                        ...
                        reference.child(details.getCollegeUID()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                if (details1 != null) {
                                    details1.setTestScores(localTestScores);
                                }
                                if (details1 != null) {
                                    if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
                                        ...
                                        details1.setTestDate(s1);
                                    }else {
                                        Toast.makeText(StudentStartTest.this, "Application Requires Android 8", Toast.LENGTH_SHORT).show();
                                        finish();
                                        System.exit(1);
                                    }
                                    details1.setTakenTest(true);
                                }
                                ...
                                reference1.child(details.getCollegeUID()).setValue(collegeDetails, (error, ref) -> {
                                    Toast.makeText(StudentStartTest.this, "Successfully Gave the Test", Toast.LENGTH_SHORT).show();
                ...
                event.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if(currentA == 0){
                            Toast.makeText(StudentStartTest.this, "Select a Score", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        localTestScores.add(currentA);
                        currentA = 0;
